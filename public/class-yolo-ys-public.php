    ...
    public function enqueue_styles() {
        ...
        if (is_a($post, 'WP_Post')) {
            if (has_shortcode($post->post_content, 'yolo_yacht_details') || 
                ...
                wp_enqueue_style(
                    'bootstrap-grid',
                    'https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap-grid.min.css',
                    array(),
                    '5.3.2'
                );
            }
        ...
        // Emergency override CSS (loaded LAST with highest priority)
        wp_enqueue_style(
            'yolo-ys-emergency-override',
            YOLO_YS_PLUGIN_URL . 'public/css/emergency-override.css',
            array('bootstrap-grid', 'yolo-ys-yacht-card'),
            $this->version,
            'all'
        );
