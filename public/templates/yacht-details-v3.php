...
<div class="yolo-yacht-details-v3">
    ...
    <div class="container-fluid px-0">
        <div class="row g-4">
            ...
            <!-- Cancellation Policy -->
            <?php if (!empty($yacht->cancellation_policy)): ?>
            <div class="yacht-cancellation-policy">
                <h3><i class="fa-solid fa-file-contract"></i> Cancellation Policy</h3>
                <div class="policy-content">
                    <?php echo wp_kses_post(nl2br($yacht->cancellation_policy)); ?>
                </div>
            </div>
            <?php endif; ?>
