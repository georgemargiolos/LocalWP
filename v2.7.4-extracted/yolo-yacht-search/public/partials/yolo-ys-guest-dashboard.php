                                    ...
                                    <tbody>
                                        <?php for ($i = 1; $i <= 12; $i++): ?>
                                            <tr class="yolo-crew-row" data-index="<?php echo $i; ?>">
                                                <td><?php echo $i; ?></td>
                                                <td><input type="text" name="crew[<?php echo $i; ?>][first_name]" placeholder="Name"></td>
                                                <td><input type="text" name="crew[<?php echo $i; ?>][last_name]" placeholder="Surname"></td>
                                                <td>
                                                ...
                                                <td><input type="text" name="crew[<?php echo $i; ?>][id_number]" placeholder="ID/Passport No."></td>
                                                <td><input type="date" name="crew[<?php echo $i; ?>][birth_date]"></td>
                                                <td>
                                                ...
                                                <td><input type="tel" name="crew[<?php echo $i; ?>][mobile_number]" placeholder="Mobile"></td>
                                                <td><input type="text" name="crew[<?php echo $i; ?>][nationality]" placeholder="Nationality"></td>
                                            </tr>
                                        <?php endfor; ?>
                                    </tbody>
                                </table>
