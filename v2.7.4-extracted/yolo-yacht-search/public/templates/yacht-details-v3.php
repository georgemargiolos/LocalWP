...
<div class="yolo-yacht-details-v3">
    ...
    <div class="yacht-quick-specs">
        ...
        <?php if (!empty($yacht->checkin_day) && !empty($yacht->checkin_time)): ?>
        <?php
            // Convert day number to day name (Booking Manager: 1=Sunday, 7=Saturday)
            $day_names = ['', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
            $checkin_day_name = isset($day_names[$yacht->checkin_day]) ? $day_names[$yacht->checkin_day] : 'N/A';
        ?>
        <div class="spec-item">
            <div class="spec-icon">📅</div>
            <div class="spec-value"><?php echo esc_html($checkin_day_name); ?></div>
            <div class="spec-label">Check-in Day</div>
        </div>
        <div class="spec-item">
            <div class="spec-icon">🕐</div>
            <div class="spec-value"><?php echo esc_html($yacht->checkin_time); ?> - <?php echo esc_html($yacht->checkout_time); ?></div>
            <div class="spec-label">Check-in/out Time</div>
        </div>
        <?php endif; ?>
