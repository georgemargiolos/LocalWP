    ...
    document.getElementById('bookingForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo admin_url('admin-ajax.php'); ?>', {
            ...
            body: new URLSearchParams({
                ...
                included_extras: window.yoloLivePrice ? window.yoloLivePrice.includedExtras : 0,
                extras_at_base: window.yoloLivePrice ? window.yoloLivePrice.extrasAtBase : 0,
                extras_details: window.yoloLivePrice ? JSON.stringify(window.yoloLivePrice.extrasDetails) : '[]'
            })
        })
        .then(response => response.json())
        .then(data => {
