...
class YOLO_YS_Booking_Manager_API {
    ...
    /**
     * v91.20: Get all companies from API
     * 
     * @return array Array of company objects with id, name, country
    ...
    public function get_all_companies() {
        ...
        if ($result['success']) {
            // API returns array of companies or { "value": [...] }
        ...
        throw new Exception(isset($result['error']) ? $result['error'] : 'Failed to fetch companies');
    }
