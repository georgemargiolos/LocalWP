        ...
        window.yoloDatePicker.on('selected', function(date1, date2) {
            ...
            .then(data => {
                ...
                if (data.success && data.data && data.data.available) {
                    ...
                    priceFinal.style.color = ''; // Reset color
                    ...
                    // ❌ NOT Available - FIX v60.6.14: Handle BOTH success:false AND available:false cases
                    ...
                    // Get error message from either success or error response format
                    let errorMessage = 'This yacht is not available for the selected dates. Please choose different dates.';
                    ...
                    // Clear stored live price
                    window.yoloLivePrice = null;
                }
            })
            .catch(error => {
