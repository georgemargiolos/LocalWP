...
// FIXED: Use output buffering to catch any stray PHP warnings that would break JavaScript
$fb_event_id = '';
if (function_exists('yolo_analytics')) {
    ...
    ob_end_clean(); // Discard any output (warnings, notices, etc.)
}
// Ensure fb_event_id is a clean string
