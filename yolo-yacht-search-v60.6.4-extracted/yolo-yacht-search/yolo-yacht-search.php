...
// Initialize analytics and SEO (v41.19) - Fixed: moved to plugins_loaded hook to prevent critical errors
add_action('plugins_loaded', function() {
    yolo_analytics();
    yolo_meta_tags();
}, 10);

// Initialize icons admin (admin-only)
