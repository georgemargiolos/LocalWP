...
if (is_admin()) {
    ...
    // Initialize admin documents management
    $admin_documents = new YOLO_YS_Admin_Documents();
}

// Initialize quote requests system
$quote_requests = new YOLO_YS_Quote_Requests();
