...
class YOLO_YS_Database {
    ...
    public function store_yacht($yacht_data, $company_id) {
        ...
        $yacht_insert = array(
            ...
            'checkin_time' => isset($yacht_data['checkin_time']) ? $yacht_data['checkin_time'] : null,
            'checkout_time' => isset($yacht_data['checkout_time']) ? $yacht_data['checkout_time'] : null,
            'checkin_day' => isset($yacht_data['checkin_day']) ? $yacht_data['checkin_day'] : null,
